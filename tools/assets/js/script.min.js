    ...
    <div class="col">
      <div class="card shadow-sm h-100">
        <div class="card-body d-flex flex-column card-chinese">
          ...
          <p class="card-text mt-auto" style="padding-left:3.75rem">${buildIdiomCardContent(e)}</p>
        </div>
      </div>
